...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.warn('Fallback to base64 Data URL for uploaded media in host app:', storageErr);
    ...
    if (id && id !== 'temp' && !id.startsWith('demo-')) {
      try {
        ...
        console.warn('Could not insert event_media record immediately in host app:', dbErr);
      }
    }
