...
export function GiftHero({ recipient }: GiftHeroProps) {
  return (
    <section className="relative pt-6 pb-8 px-4 sm:px-6 max-w-2xl mx-auto w-full text-center">
      ...
      >
        ...
        {/* Moldura Branca Estilo Polaroid com Cantos Arredondados */}
        <div className="bg-white p-3.5 sm:p-4 rounded-3xl shadow-md border border-brand-rose/30 hover:shadow-lg transition-shadow duration-300">
          <div className="relative rounded-2xl overflow-hidden bg-brand-cream aspect-[4/5]">
            <MediaPlaceholder
              ...
              sublabel="Substituir pela fotografia do Matheus Akira"
        ...
        <div className="absolute -bottom-2.5 -right-2.5 w-9 h-9 rounded-full bg-brand-wine text-brand-cream flex items-center justify-center shadow-md border-2 border-brand-cream">
