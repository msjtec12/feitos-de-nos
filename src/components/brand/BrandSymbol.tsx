...
export function BrandSymbol({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* Laço do Coração - Lado Vinho / Primário */}
      <path
      ...
      <rect x="68" y="32" width="4.5" height="14" rx="2.25" fill="var(--theme-accent, #C96E5A)" />
      <rect x="76" y="24" width="4.5" height="30" rx="2.25" fill="var(--theme-accent, #C96E5A)" />
      <rect x="84" y="32" width="4.5" height="14" rx="2.25" fill="var(--theme-accent, #C96E5A)" />
    </svg>
  );
}
