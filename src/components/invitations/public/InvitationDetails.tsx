      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-black/5 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl text-xs sm:text-sm font-semibold border transition-all hover:bg-black/5 active:scale-[0.98]"
        ...
        {/* Dress code */}
        {dressCode && (
          <div className="pt-4 border-t border-black/5 flex items-center justify-center gap-2 text-xs text-[#302B2D]/80">
